...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Race leMans = new CircuitRace(8000, "Start - Finish", 20000, parkedCars, 5000);
        Race goodWood = new TimeLimitRace(1900, "Base of mountain - Mountain peak", 3000, parkedCars, 40);

        Race[] allFinishedRaces = {monaco, tokio, leMans, goodWood};
